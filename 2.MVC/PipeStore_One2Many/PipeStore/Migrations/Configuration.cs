    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PipeStore.Models.PipeDBContext>
    {
        ...
        protected override void Seed(PipeStore.Models.PipeDBContext context)
        {
            ...
            context.Standards.AddOrUpdate(
                i => i.Title,
                new Standard { Title = "Gost 3262-78" },
                new Standard { Title = "Gost 8732-78" },
                new Standard { Title = "Gost 9940-78" },
                new Standard { Title = "ANSI 56894" },
                new Standard { Title = "ANSI 65432" },
                new Standard { Title = "DSTU 9940-2000" },
                new Standard { Title = "TU 14-3-456-87" }
            );

            context.Manufacturers.AddOrUpdate(
                i => i.Name,
                new Manufacturer { Name = "Ukraine" },
                new Manufacturer { Name = "Russia" },
                new Manufacturer { Name = "Germany" },
